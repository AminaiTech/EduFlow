                ...
                >
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <p className="text-indigo-100 text-lg md:text-xl mb-12 opacity-90">
                            Ready to scale your educational ecosystem? Join <Link href="https://aminaitech.com" target="_blank" className="text-white font-bold">Aminai Tech</Link> and streamline your management today.
                        </p>
                        <form
