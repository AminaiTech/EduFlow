                ...
                <div className="flex flex-col lg:flex-row gap-16 items-start mb-24">
                    ...
                    >
                        ...
                        <div className="space-y-6 text-slate-400 text-lg leading-relaxed">
                            <p>
                                <span className="text-white font-semibold">Acafort</span> is a next-generation school management platform dedicated to building sustainable digital infrastructure for education.
                            </p>
                            <p>
                        ...
                        <div className="bg-slate-900 shadow-2xl border border-white/5 rounded-[2.5rem] p-8 space-y-8 relative overflow-hidden">
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-400 text-sm mb-8">
                                    We intentionally align Acafort with the United Nations Sustainable Development Goals to build greener, more resilient systems.
                                </p>
